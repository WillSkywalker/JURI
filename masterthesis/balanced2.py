...
class Experiment2:
    ...
    def __init__(self, eng_embedding, fre_embedding, name=None):
        ...
        self.y_test = []
        if name:
            self.name = 'balancemaster2-' + name
        else:
            self.name = 'balancemaster2-'+str(datetime.datetime.now())
    ...
    def predict_en(self, load_model=False):
        ...
        #     results.append(1)
        new_appnos, new_decs, results = balance(new_appnos, new_decs, results)
